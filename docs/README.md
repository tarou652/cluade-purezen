...
Book Summary Slides プロジェクトのドキュメント一覧。
...
- [../slides.md](../slides.md) — Slidev の機能を実演するデモデッキ（`npm run dev` で開く入口）
- [../examples/book-template.md](../examples/book-template.md) — 本要約用のスライド雛形
